...
export interface EntryPoint_v100Interface extends utils.Interface {
    functions: {
...
export interface EntryPoint_v100 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: EntryPoint_v100Interface;
